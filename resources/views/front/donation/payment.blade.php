...
@section('title', 'Terimakasih user')
...
@section('content')
    <div class="container py-5">
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <h5 class="text-center">Terimakasih Username</h5>
                ...
                <div class="row justify-content-between mt-3 mt-lg-4">
                    <div class="col-lg-3 col-md-4 text-center">
                        <img src="{{ asset('/img/bank/bri.jpeg') }}" alt="" class="w-100">
                        <p class="mt-3 text-muted">0000875645647543</p>
                    </div>
                    <div class="col-lg-3 col-md-4 text-center">
                        <img src="{{ asset('/img/bank/bni.jpeg') }}" alt="" class="w-100">
                        <p class="mt-3 text-muted">00008756353535353</p>
                    </div>
                    <div class="col-lg-3 col-md-4 text-center">
                        <img src="{{ asset('/img/bank/bca.jpeg') }}" alt="" class="w-100">
                        <p class="mt-3 text-muted">00008756898732328</p>
                    </div>
                </div>
                <p class="text-center mt-3 mt-lg-4">
                    Harap transfer sesuai dengan nominal tagihan "<strong>TOTAL TAGIHAN</strong>" ke bank yang tertera di atas! Setelah transfer lakukan konfirmasi pembayaran! perbedaan nilai transfer akan menghambat proses verifikasi.
                </p>
                ...
                <div class="informasi d-flex justify-content-center align-items-center mt-3 mt-lg-4" >
                    ...
                    <div class="bg-white rounded-right info text-center w-100 p-4 h-100">
                        <p>Kami sudah membuatkan akun Youthped untuk anda, Silahkan cek email anda.</p>
                        <strong>(example@Youthped.com)</strong>
                    </div>
                </div>
            </div>
        </div>
