            ...
            <div class="col-lg-10">
                ...
                <form action="{{ url('/donation/' .$campaign->id. '/payment-confirmation/' .$donation->order_number) }}" method="POST" class="mt-3 mt-lg-4" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') ?? ($payment->name ?? $campaign->user->name)}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nominal" class="form-control @error('nominal') is-invalid @enderror" value="{{ old('nominal') ?? ($payment->nominal ?? $donation->nominal) }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-file">
                            <input type="file" class="custom-file-input @error('path_image') is-invalid @enderror" id="path_image" name="path_image" onchange="preview('.preview-path_image', this.files[0])">
