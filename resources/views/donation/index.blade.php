    ...
    <x-card>
      <x-slot name="header">
        @if (auth()->user()->hasRole('admin'))
            <button onclick="addForm('{{ route('campaign.store') }}')" class="button btn btn-primary"><i class="fas fa-plus-circle"></i> Tambah</button>
        @else
            <a href="{{ url('/campaign') }}" class="button btn btn-primary"><i class="fas fa-plus-circle"></i> Tambah</a>
        @endif
