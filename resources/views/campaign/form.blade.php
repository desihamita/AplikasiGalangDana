        ...
        <div class="form-group">
          <label for="publish_date">Tanggal Publish</label>
            <div class="input-group datetimepicker" id="publish_date" data-target-input="nearest">
                <input type="text" name="publish_date" class="form-control datetimepicker-input" data-target="#datetimepisker1"/>
                <div class="input-group-append" data-target="#datetimepisker1" data-toggle="datetimepicker">
        ...
        <div class="form-group">
          <label for="end_date">Tanggal Selesai</label>
            <div class="input-group datetimepicker" id="end_date" data-target-input="nearest">
                ...
                <div class="input-group-append" data-target="#end_date" data-toggle="end_date">
                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                </div>
            </div>
        </div>
      ...
      <div class="col-lg-6">
        <div class="form-group">
          ...
          <div class="custom-file">
            <input type="file" name="path_image" class="custom-file-input" id="path_iamge" onchange="preview('.preview-path_image', this.files[0])">
