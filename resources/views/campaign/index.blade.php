...
<div class="row">
  <div class="col-lg-12">
    <x-card>
      <x-slot name="header">
        <a onclick="addForm('{{ route('campaign.store') }}')" class="button btn btn-primary"><i class="fas fa-plus-circle"></i> Tambah</a>
      </x-slot>
...
<script>
  ...
  function resetForm(selector) {
    ...
    $('.form-control, .custom-select, [type=checkbox], [type=radio], [type=file], .select2, .note-editor').removeClass('is-invalid');
    $('.note_editor').removeClass('is-invalid')
